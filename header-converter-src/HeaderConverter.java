...
public class HeaderConverter {
    ...
    private static void processInputJar(String inputPath, String outputPath) throws IOException {
                ...
                if (entryName.equals("fabric.mod.json")) {
                    try (InputStream stream = jarFile.getInputStream(entry)) {
                        ...
                        System.out.println("Detected fabric.mod.json ("
                                + fabricModJsonBytes.length + " bytes) — this is a Fabric mod");
                    }
                    continue;
                }
        ...
        // --- Mod-type detection defines ---
        resultFile.append("// Mod type detected at build time\n");
        if (isFabricMod) {
        ...
        // --- fabric.mod.json data (present only for Fabric mods) ---
        if (isFabricMod) {
            ...
            resultFile.append("// No fabric.mod.json in this JAR\n");
